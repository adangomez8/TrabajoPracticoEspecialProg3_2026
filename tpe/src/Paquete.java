public class Paquete {
    ...
    public Paquete(int idPaquete, String codigoPaquete, double pesoKg,
                   boolean contieneAlimentos, int nivelUrgencia) {
        this.id_paquete = idPaquete;
        this.codigo_paquete = codigoPaquete;
        this.peso_kg = pesoKg;
        this.contiene_alimentos = contieneAlimentos;
        this.nivel_urgencia = nivelUrgencia;
    }
    ...
    public String toString() {
        return "Paquete: " + codigo_paquete + ", peso_kg=" + peso_kg;
    }
}